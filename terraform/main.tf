...
locals {
  ...
  # The fast-checkout experiment: hold checkout to a hard 10s ceiling (increased from 3s to
  # accommodate the 5s payment gateway latency), and route payments through the processor's
