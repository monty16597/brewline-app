...
locals {
  ...
  # Checkout timeout must accommodate synchronous calls to the payment gateway, which takes ~5
  # seconds to authorize payments. Set to 30 seconds to provide adequate headroom for payment
  # latency plus checkout processing (inventory checks, order creation, etc.).
  checkout_timeout = 30
