...
locals {
  ...
  # The fast-checkout experiment: hold checkout to a hard 10s ceiling to accommodate the 5s
  # payment delay, and route payments through the processor's slower settlement tier.
